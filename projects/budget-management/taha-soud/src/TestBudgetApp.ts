...
(function testBudgetApp() {
  ...
  const initialBalanceUser1 = app.getUsers().find(user => user.userName === 'user1')?.balance ?? 0;
  const initialBalanceUser2 = app.getUsers().find(user => user.userName === 'user2')?.balance ?? 0;
